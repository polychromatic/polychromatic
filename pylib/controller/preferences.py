...
#
"""
This module controls the 'Preferences' tab of the Controller GUI.
"""
...
class PreferencesTab(shared.TabData):
    """
    ...
    def set_tab(self):
        """
        Preferences tab opened.
        """
        print("stub: PreferencesTab.set_tab")
