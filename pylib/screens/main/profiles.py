...
"""
Polychromatic Pages Module: Profiles (subpage of main)

Lists and provides options for managing profiles, a way
of combining a set of effects that apply to set of devices.
"""
